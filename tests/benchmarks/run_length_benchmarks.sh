for i in {10..20}; do
	time python benchmark.py -q seqs/hg38.experiment.$i.5000.fasta -c hg38.office.config.json -o output/hg38.experiment.$i.5000 -i 100
	time python benchmark.py -q seqs/hg38.experiment.$i.7000.fasta -c hg38.office.config.json -o output/hg38.experiment.$i.7000 -i 100
